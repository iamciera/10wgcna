...
#use Dan Koenig's data. Now I am verifying what I did in WGNCNA.bootstrap.Ciera.03.26.15.R and also trying to 
#understand why many of the genes are not used in the analysis.
...
pdf("top.hub.test.032715.pdf", useDingbats=FALSE) 
plot(subnet, 
